...
test('StartOf', () => {
    ...
    const startOfMillisecond = date_utils.start_of(date, 'millisecond');
    expect(date_utils.to_string(startOfMillisecond, true)).toBe('2017-08-12 15:07:34.012');

    const startOfSecond = date_utils.start_of(date, 'second');
    expect(date_utils.to_string(startOfSecond, true)).toBe('2017-08-12 15:07:34.000');

    const startOfMinute = date_utils.start_of(date, 'minute');
    expect(date_utils.to_string(startOfMinute, true)).toBe('2017-08-12 15:07:00.000');

    const startOfHour = date_utils.start_of(date, 'hour');
    expect(date_utils.to_string(startOfHour, true)).toBe('2017-08-12 15:00:00.000');

    const startOfDay = date_utils.start_of(date, 'day');
    expect(date_utils.to_string(startOfDay, true)).toBe('2017-08-12 00:00:00.000');

    const startOfMonth = date_utils.start_of(date, 'month');
    expect(date_utils.to_string(startOfMonth, true)).toBe('2017-08-01 00:00:00.000');

    const startOfYear = date_utils.start_of(date, 'year');
    expect(date_utils.to_string(startOfYear, true)).toBe('2017-01-01 00:00:00.000');
});
