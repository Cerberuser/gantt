...
export default class Bar {
    ...
    public $bar: SVGGraphicsElement;
    public task: ITaskInternal;
    public arrows: Arrow[];
    ...
    public update_bar_position({x = null, width = null}: { x?: number, width?: number }) {
        if (x) {
            ...
            const valid_x = xs.reduce(((prev: any, curr: any) => {
                return x >= curr;
